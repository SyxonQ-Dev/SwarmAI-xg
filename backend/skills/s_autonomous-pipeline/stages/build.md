...
```bash
# The prompt lives in data/gate-prompts/gate1-skeptic.md — emit it, do not retype it.
...
python backend/skills/s_autonomous-pipeline/scripts/spawn_prompt.py --gate gate1-skeptic
```
